...
##hvg <- readRDS(file = paste0(inputdir, "HVG.byCTP.combine.rds"))[["1500"]]
...
p_scale <- p_scale + 
            theme(axis.text.x = element_blank())
pdf(paste0(outputdir, "DIV_1minusCor_combine.pdf"), width = 10, height = 4)
plot_grid(p_raw, p_scale, nrow = 3, ncol = 1, align = "v") %>% print()
dev.off()
