...
marlist <- readRDS(file = paste0(inputdir, "L23IT.speccls.putative.markers.rds"))
...
all_types <- c("Human ARHGAP18", "Chimpanzee ARHGAP18", "Rhesus ARHGAP18") 
type_list <- list()
...
pdf(paste0(outputdir, "SF.validate.spec-clusters.L2-3IT.AUC.cbn.pdf"), width = 3.5 * (2 + length(all_types)), height = 3.5 * 4)
